...
<table class="table table-striped" style="">
        <tbody>
          ...
          <tr>
            <td class="statustableitemnames">Used Memory</td>
            <td class="statustableitemvalues"><span name="tableUsedMemory" class="tableUsedMemory" id="tableUsedMemory">Loading.....</span></td>
          </tr>
          <tr>
            <td><a onclick="deleteLog();" style="cursor: pointer;" >Log File Size (Click to clear)</a></td>            <td><span name="tableLogSize" class="tableLogSize" id="tableLogSize">Loading.....</span></td>
          </tr>
          <tr>
